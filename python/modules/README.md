...
Если кроме функций, констант и переменных в модуле прописаны команды вне функций, то при импортировании модуля весь этот код выполнится (как обычный скрипт). При этом, все атрибуты модуля будит, импортироваться (как библиотека).
