...
| <samp>CHAR</samp> [char](char)| строка фиксированной длины | Диапазон от `1` до `255` символов, пробелы по краям обрезаются при получении значения, заполняется пробелом до заданной длины (если символов меньше, чем заданная длина), сортировка и сравнение значений регистро-независимое |
| <samp>VARCHAR</samp> [varchar](char) | строка изменяющийся длины | Диапазон от `1` до `255` символов, пробелы по краям обрезаются при сохранении, сортировка и сравнение значений регистро-независимое |
