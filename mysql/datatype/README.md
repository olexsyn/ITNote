...
| <samp>CHAR</samp> [char](/mysql/datatype/char.md)| строка фиксированной длины | Диапазон от `1` до `255` символов, пробелы по краям обрезаются при получении значения, заполняется пробелом до заданной длины (если символов меньше, чем заданная длина), сортировка и сравнение значений регистро-независимое |
| <samp>VARCHAR</samp> [char](/mysql/datatype/char.md) | строка изменяющийся длины | Диапазон от `1` до `255` символов, пробелы по краям обрезаются при сохранении, сортировка и сравнение значений регистро-независимое |
...
| <samp>ENUM</samp> | перечисление | строковый объект, может иметь только одно значение из списка, максимальное количество уникальных элементов – `65535` |
