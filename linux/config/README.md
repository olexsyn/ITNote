...
Здесь выполняется [настройка монтирования файловых систем](.config_files/fstab) во время загрузки. В современных системах он читается systemd и все записи на ходу транслируются в юнит-файлы, с помощью которых уже выполняется монтирование.
