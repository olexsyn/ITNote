...
{% include cmdout.htm cmd="$ rsync -n -av /tmp/photos ~"
...
{% include cmdout.htm cmd="$ rsync -av /tmp/photos/ ~"
out="./
Photo 2.jpg
Photo 3.jpg
Photo 6.jpg
...
{% include cmdout.htm cmd="$ rsync -av /tmp/photos example.com:album"
out="created directory album
photos/
photos/Photo 2.jpg
photos/Photo 3.jpg
photos/Photo 6.jpg
...
{% include cmdout.htm cmd="$ ?WHAT?"
out="drwxr-xr-x         238 2009/08/22 18:49:50 photos
...
{% include cmd.htm cmd="$ rsync -av whatever.example.com::src /tmp" %}
...
{% include cmdo.htm cmd="$ sudo rsync --daemon" %}
...
{% include cmd.htm cmd="kill -INT 'cat /home/strike/rsyncd/rsyncd.pid'" %}
...
{% include cmd.htm cmd="$ rsync --daemon --config=rsyncd.conf" %}

Теперь, соединимся с демоном с другой машины, не указывая при этом имя модуля. Мы увидим следующее:

{% include cmdout.htm cmd="rsync --port=7777 mymachine.example.com::"
...
{% include cmdout.htm cmd="$ rsync -v --port=7777 application.js mymachine.example.com::dropbox"
out="Hello! Welcome to Martin's rsync server.
