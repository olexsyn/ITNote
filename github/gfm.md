...
**Markdown** – это упрощенный язык разметки, который который интерпретируется в код HTML. GitHub расширил возможности стандартного Markdown, добавив возможность интерпретации таблиц (:question: только?). Markdown может содержать в себе вставки обычного HTML-кода.
